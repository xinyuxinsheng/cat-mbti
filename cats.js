...
// --- 24 道题目（题库 v2：每轴 6 题、正反 3-3、四维交错，2026-07-08 起偏离 reference） ---
const QUESTIONS = [
  { id: 1,  text: '听到门铃响或快递员敲门，会主动跑到门口迎接', dim: 'EI', dir: 1 },
  { id: 2,  text: '突然的声响（吸尘器、吹风机、炒菜声）会把它吓得弹飞', dim: 'SN', dir: -1 },
  { id: 3,  text: '吃饭时护食——你的手或其他宠物靠近它的碗，它会挡开、哈气或加速吞咽', dim: 'TF', dir: 1 },
  { id: 4,  text: '经常有出乎意料的反应，你永远猜不到它下一步干什么', dim: 'JP', dir: -1 },
  { id: 5,  text: '家里来客人时，会躲到床底、衣柜或其他隐蔽角落', dim: 'EI', dir: -1 },
  { id: 6,  text: '快递箱一到家，它比你还急着钻进去探索', dim: 'SN', dir: 1 },
  { id: 7,  text: '只要你呼唤它、摸摸它，它基本都会温和地回应你', dim: 'TF', dir: -1 },
  { id: 8,  text: '作息非常规律，几点吃饭几点睡觉你都能猜到', dim: 'JP', dir: 1 },
  { id: 9,  text: '陌生人伸手，它会大方凑过去蹭一蹭、闻一闻', dim: 'EI', dir: 1 },
  { id: 10, text: '生活作息几乎一成不变，喜欢待在固定的老地方，不爱折腾', dim: 'SN', dir: -1 },
  { id: 11, text: '没有按时喂饭或者被忽视时，会大声叫唤甚至发脾气', dim: 'TF', dir: 1 },
  { id: 12, text: '注意力很短，一个玩具玩不了两分钟就去找别的了', dim: 'JP', dir: -1 },
  { id: 13, text: '对第一次来家里的人，会反复犹豫要不要靠近', dim: 'EI', dir: -1 },
  { id: 14, text: '热衷于巡视家里每个角落，柜顶、窗台、洗衣机上面都是它的地盘', dim: 'SN', dir: 1 },
  { id: 15, text: '你情绪低落时，它会凑过来挨着你、安静地陪着你', dim: 'TF', dir: -1 },
  { id: 16, text: '做事之前会先观察和思考，不会贸然冲上去', dim: 'JP', dir: 1 },
  { id: 17, text: '家里人来人往也能淡定自若，该吃吃该睡睡', dim: 'EI', dir: 1 },
  { id: 18, text: '对没见过的东西提不起兴趣，看两眼就走开', dim: 'SN', dir: -1 },
  { id: 19, text: '见到陌生的猫——不管是现实里、窗外还是屏幕里的——会炸毛、哈气或上爪，摆出强势姿态', dim: 'TF', dir: 1 },
  { id: 20, text: '情绪变化很快，上一秒还在撒娇，下一秒就炸毛或咬人', dim: 'JP', dir: -1 },
  { id: 21, text: '大部分时间独自待着，不怎么主动找人黏人', dim: 'EI', dir: -1 },
  { id: 22, text: '买了新玩具或猫爬架，它会兴奋地研究很久', dim: 'SN', dir: 1 },
  { id: 23, text: '被你骂了或凶了，会委屈地躲起来，好一会儿不理你', dim: 'TF', dir: -1 },
  { id: 24, text: '有自己的小仪式：吃饭前绕固定路线、睡前踩奶铺床，流程雷打不动', dim: 'JP', dir: 1 },
];
