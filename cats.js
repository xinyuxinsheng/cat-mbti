...
const QUESTIONS = [
  ...
  { id: 7,  text: '你呼唤它时，它基本都会有回应（抬头、喵一声或走过来）', dim: 'TF', dir: -1 },
  { id: 8,  text: '作息非常规律，几点吃饭几点睡觉你都能猜到', dim: 'JP', dir: 1 },
  { id: 9,  text: '陌生人伸手，它会大方凑过去蹭一蹭、闻一闻', dim: 'EI', dir: 1 },
  { id: 10, text: '喜欢待在固定的老地方，很少主动探索家里的新角落', dim: 'SN', dir: -1 },
  { id: 11, text: '没有按时喂饭时，它会大声叫唤催促，甚至发脾气', dim: 'TF', dir: 1 },
  { id: 12, text: '注意力很短，一个玩具玩不了两分钟就去找别的了', dim: 'JP', dir: -1 },
  { id: 13, text: '对第一次来家里的人，会反复犹豫要不要靠近', dim: 'EI', dir: -1 },
  { id: 14, text: '热衷于巡视家里每个角落，哪儿都要爬上去检查一遍', dim: 'SN', dir: 1 },
